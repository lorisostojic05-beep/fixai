...
// Numero minimo di messaggi perché valga la pena riprendere.
//
// Era 2: sotto quella soglia c'è solo il benvenuto, e ad agosto — quando il
// recupero serviva per gli arresti improvvisi di Android — riproporre una
// diagnosi in cui non era ancora successo niente sembrava inutile.
//
// Dal 06/09/2026 è 1, perché il caso più frequente è cambiato: col tasto
// indietro si esce DI PROPOSITO, e chi lo fa ha già pagato. Anche quando c'è
// solo il benvenuto, la sessione contiene elettrodomestico, marca e problema:
// scartarla significa fargli riscrivere tutto senza motivo. Il pagamento non
// si perde comunque, ma il contesto sì.
const MINIMO_MESSAGGI = 1;
