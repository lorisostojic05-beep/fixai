...
// L'estensione .js serve: Next.js la sottintende, Node in modalità ESM no.
// Senza, questo modulo non si può più provare da riga di comando — che è il
// modo in cui l'abbiamo verificato finora.
import { prendiPluginSubito } from "./plugin-nativo.js";
...
// └───────────────────────────────────────────────────────────────────────────┘
// 12 (2.0) pubblicata in produzione il 06/09/2026, scheda verificata.
export const VERSIONE_PUBBLICATA = 12;
...
//
// Per la stessa ragione prendiPluginSubito si importa in cima al file e non
// con un import() dinamico. Il commento qui sopra metteva in guardia dal
// pericolo, e poi la riga sotto lo ripeteva con un modulo nostro: anche
// quello e' un file scaricato dalla rete, e dopo un deploy che rinomina i
// file la promessa non si risolve mai. Il 05/09/2026 e' costato la
// protezione del tasto indietro, che restava spenta senza dirlo a nessuno.
