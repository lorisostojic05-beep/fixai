...
//   node scripts/traduci.mjs ro

export default {
  "meta": {
    "titolo": "Fixi — Diagnosticarea electrocasnicelor prin AI",
    "descrizione": "Economisește costul vizitei tehnicianului. Diagnosticare AI prin videocall în 10 minute."
  },
  "nav": {
  ...
  "lingua": {
    "scegli": "Alege limba",
    "disponibileIn": "Această pagină este disponibilă în italiană"
  },
  "hero": {
    "badge": "Diagnoză AI în 10 minute",
    "titolo1": "Mașina de spălat s-a stricat.",
    "titolo2": "Fără panică.",
    "sottotitolo": "O AI te ghidează printr-un apel video, identifică problema și îți oferă un raport precis. Fără să aștepți tehnicianul. Fără să plătești 80 € doar ca să vină.",
  ...
  "telefono": {
    ...
    "bolla1": "Am văzut panoul. Încearcă să deșurubezi capacul cu o cârpă — ar putea ieși apă reziduală.",
    "bolla2": "Gata, era păr",
  ...
  "numeri": [
    ...
    {
      "valore": "10 min",
      "etichetta": "Timp mediu sesiune"
    },
    {
      "valore": "80%",
      "etichetta": "Rezolvate singur"
    },
    {
      "valore": "70 €",
      "etichetta": "Economie medie"
    }
  ],
  "passi": {
    ...
    "sottotitolo": "Fără așteptare, fără surprize. În mai puțin de 15 minute știi exact ce nu funcționează.",
    "elenco": [
      {
        "titolo": "Descrie problema",
        "testo": "Selectează electrocasnicul, introdu marca și descrie defecțiunea în câteva cuvinte."
      },
      {
        "titolo": "Plătește 9,90 €",
        "testo": "Plată securizată cu cardul. Mult mai puțin decât o vizită a tehnicianului."
      },
      {
        "titolo": "Videoapel cu AI",
        "testo": "Îndreaptă camera spre electrocasnic. AI analizează și te ghidează pas cu pas."
      },
      {
        "titolo": "Primești raportul",
        "testo": "Diagnostic, soluție DIY și estimare de cost dacă e nevoie de tehnician. În format PDF."
      }
    ]
  },
  "perche": {
    "tag": "De ce Fixi",
    "titolo1": "Diagnostic precis.",
    "titolo2": "Raport în mână.",
    "elenco": [
      {
        "titolo": "AI cu vedere",
      ...
      },
      {
        ...
        "testo": "Nu te lasă singur. Îți spune exact ce să faci, cum să faci și în ce ordine."
      },
      {
        "titolo": "Raport pentru tehnician",
        "testo": "Dacă nu reușești singur, ai un document cu diagnostic și prețuri corecte de arătat tehnicianului."
      },
      {
        "titolo": "Toate mărcile",
        "testo": "Bosch, Samsung, Indesit, Whirlpool, Miele, LG, Candy și multe altele."
      }
    ],
    "esempioTitolo": "Exemplu de raport",
    "referto": {
  ...
  "prezzi": {
    "tag": "Prețuri",
    "titolo": "Simplu și transparent.",
    "sottotitolo": "Fără abonament: plătești doar când ai nevoie.",
    "nome": "Diagnoză unică",
    "importoValuta": "€",
    "importoIntero": "9",
    "importoCentesimi": ",90",
    "periodo": "pe sesiune · fără abonament",
    "caratteristiche": [
      "30 min videoapel AI",
  ...
  "tecnici": {
    ...
    "sottotitolo": "Primești lucrări calificate cu diagnoză deja făcută. Fără cost de înscriere, fără credite de cumpărat: în această fază de lansare contactele nu te costă nimic.",
    "vantaggi": [
      {
        "titolo": "Clienți deja calificați",
        "testo": "Vin cu diagnoză și raport — știi deja ce ai de făcut înainte să pleci la client."
      },
      {
        "titolo": "Cost zero",
        "testo": "Înscriere gratuită și fără comision: în faza de lansare contactele sunt gratuite."
      },
      {
  ...
  "finale": {
    "tag": "Începe acum",
    "titolo1": "Mașina de spălat nu așteaptă.",
    "titolo2": "Nici tu.",
    "sottotitolo": "Diagnostic complet în 10 minute. 9,90 €. Fără programare.",
    "avvia": "Începe diagnosticul",
    "garanziaTitolo": "Mulțumit sau banii înapoi.",
    "garanziaTesto": "Dacă diagnosticul nu ți-a fost de folos, îți returnăm cei 9,90 €, în 14 zile și fără discuții."
  },
  "footer": {
    "descrizione": "Diagnoza electrocasnice prin AI",
    "guide": "Ghiduri",
  ...
  "email": {
    ...
    "sottotitolo": "Diagnostic electrocasnice prin apel video AI",
    "intestazione": "Raport {numero} — {data}",
    "problema": "Problemă raportată: \"{problema}\"",
    "diagnosi": "DIAGNOSTIC",
    "faiDaTe": "SOLUȚIE DIY",
    "pezzo": "PIESĂ DE SCHIMBAT",
    "codice": "Cod: {codice}",
    "prezzo": "Preț: {prezzo}",
    "stima": "ESTIMARE INTERVENȚIE TEHNICĂ",
    "mostraAlTecnico": "Arată acest raport tehnicianului pentru un preț corect.",
    "urgenza": "Urgență: {livello} — {cosaFare}",
    "urgenzaBassa": "SCĂZUTĂ",
    "urgenzaMedia": "MEDIE",
    "urgenzaAlta": "RIDICATĂ",
    "urgenzaBassaCosaFare": "Nicio grabă",
  ...
  "pdf": {
    "dataReferto": "Raport din {data}",
    "numeroReferto": "Raport #{numero}",
    "nome": "Nume: {nome}",
    "codice": "Cod: {codice}",
    "prezzoStimato": "Preț estimat: {prezzo}",
    "risolvibileDaSolo": "Rezolvabil pe cont propriu",
    "mostraAlTecnico": "Arată acest raport tehnicianului pentru un preț corect.",
    "piedeSinistra": "Fixi — Diagnoză electrocasnice cu AI",
  ...
  "privacy": {
    ...
    "traduzioneDiCortesia": "Aceasta este o traducere de curtoazie. În caz de diferențe, versiunea în italiană prevalează.",
    "chiSiamo": {
      ...
      "domande": "Pentru orice întrebare despre confidențialitate ne poți scrie la {email}."
    },
    "dati": {
      "titolo": "2. Ce date colectăm",
      "intro": "În funcție de cum folosești Fixi, prelucrăm:",
      "voci": [
        "**Date despre diagnostic**: tipul de electrocasnic, marca, descrierea problemei și mesajele pe care le schimbi cu asistentul AI.",
        "**Imagini de la cameră**: în timpul sesiunii, cadrele pe care le filmezi sunt trimise pentru analiză către AI. **Nu salvăm videoclipurile sau cadrele**: sunt procesate și apoi eliminate.",
        "**Email**: dacă alegi să primești raportul prin email sau să fii recontactat de un tehnician.",
        "**Date pentru solicitarea unui tehnician**: nume, telefon, oraș și cod poștal, pe care le partajăm cu tehnicienii din zona ta pentru a le permite să te contacteze.",
    ...
    "perche": {
      ...
      "voci": [
        ...
        "Pentru a-ți trimite raportul prin email, dacă îl soliciți.",
        "Pentru a te pune în contact cu un tehnician din zona ta, dacă soliciți asta.",
    ...
    "camera": {
      "titolo": "4. Camera",
      "testo": "Accesul la cameră este folosit **doar în timpul sesiunii de diagnosticare** și doar pentru a arăta AI-ului ceea ce filmezi. Cadrele sunt analizate în timp real și nu sunt stocate pe sistemele noastre. Poți dezactiva camera oricând în timpul sesiunii."
    },
    "terzeParti": {
    ...
    "diritti": {
      ...
      "testo": "Ai dreptul de a accesa datele tale, de a le corecta, de a cere ștergerea sau limitarea folosirii lor și de a te opune prelucrării. Pentru a-ți exercita aceste drepturi scrie-ne la {email}.",
    ...
    "modifiche": {
      ...
      "testo": "Este posibil să actualizăm această politică. În caz de modificări relevante, vom semnala acest lucru pe această pagină, actualizând data de mai sus."
    },
    "contatti": {
      "titolo": "10. Contact",
      "testo": "Pentru orice întrebare despre confidențialitate sau despre datele tale: {email}."
    },
  ...
  "cancellazione": {
    ...
    "quale": {
      ...
      "app": "Această pagină se referă la aplicația **Fixi — Diagnoza Electrocasnicelor**, dezvoltată și publicată de **{titolare}**, și la site-ul **Fixi**. Este valabilă atât pentru cei care folosesc serviciul de diagnoză, cât și pentru tehnicienii înscriși în rețea.",
      "senzaAccount": "Fixi **nu are cont și nici înregistrare**: nu există un profil de șters din aplicație. Ștergerea datelor se solicită scriindu-ne, așa cum este explicat mai jos."
    },
    "come": {
      "titolo": "Cum soliciți ștergerea",
      "passo1": "Trimite un email la {email} cu subiectul **«{oggetto}»**.",
      "passo2": "În mesaj, indică datele pe care ni le-ai furnizat, astfel încât să putem găsi informațiile tale: **adresa de email** pe care ai folosit-o pentru a primi raportul și, dacă ai solicitat intervenția unui tehnician, și **numele, numărul de telefon și codul poștal**.",
      "passo3": "Precizează dacă vrei să ștergi **toate datele** sau doar o parte (de exemplu, numai cererea de intervenție).",
    ...
    "cosaSiCancella": {
      "titolo": "Ce date sunt șterse",
      "intro": "La cererea ta, eliminăm din sistemele noastre:",
      "voci": [
        "**sesiunea de diagnoză**: electrocasnicul, marca, descrierea problemei, conversația cu asistentul AI și raportul generat;",
      ...
      "camera": "**Imaginile de la cameră** nu apar în această listă deoarece nu sunt niciodată salvate: cadrele sunt analizate în timpul sesiunii și eliminate imediat, deci nu există nimic de șters."
    },
    "cosaResta": {
    ...
    "altriDiritti": {
      ...
      "testo": "Pe lângă ștergere, poți solicita accesul la datele tale, corectarea lor, limitarea utilizării sau te poți opune prelucrării. Găsești detaliile complete în {link}.",
      "link": "politica de confidențialitate",
      "scrivi": "Pentru orice solicitare, scrie la {email}."
    },
    "vaiAllaPrivacy": "Politica de confidențialitate",
    "torna": "Înapoi la Fixi"
  },
  "stato": {
    "metaTitolo": "Stare tehnică — Fixi",
    "titolo": "Stare tehnică",
    "aCosaServe": "Te ajută să înțelegi de ce ceva nu funcționează. Fă o fotografie a acestui ecran și trimite-o dezvoltatorului aplicației.",
    "nonLetto": "Nu am reușit să citesc starea: {errore}",
    ...
    "troppoVecchia": "Această versiune nu poate lista plugin-urile: este foarte veche.",
    "presente": "prezent",
    "assente": "ABSENT",
    "prove": "Teste",
    "prova1": "1. Se văd mesajele?",
    "prova2": "2. Scrie un fișier în Download",
    "prova3": "3. Verifică microfonul",
    "prova4": "4. Generează PDF-ul raportului",
    "prova5": "5. Raport + salvare, totul împreună",
  ...
  "tecnicoIscrizione": {
    ...
    "specializzazioni": {
      ...
      "Asciugatrici": "Uscătoare de rufe",
      "Frigoriferi": "Frigidere",
      "Forni": "Cuptoare",
      "Piani cottura": "Plite",
      "Climatizzatori": "Climatizoare",
    ...
    "passo1Sotto": "Durează 3 minute. Fără costuri, fără obligații.",
    "nome": "Prenume",
    "nomeEsempio": "Mario",
    "cognome": "Nume",
    ...
    "passo2Titolo1": "Unde lucrezi",
    "passo2Titolo2": "și în ce ești specializat?",
    "citta": "Oraș",
    "cittaEsempio": "Milano",
    "cap": "Cod poștal",
    "capEsempio": "20100",
    "specializzazioniTitolo": "Specializări",
    "anni": "Ani de experiență",
    "anniEsempio": "ex. 10",
    "passo3Titolo1": "Prezintă-te",
    "passo3Titolo2": "viitorilor tăi clienți.",
    "passo3Sotto": "O scurtă descriere despre cine ești și cum lucrezi.",
    ...
    "continua": "Continuă",
    "invio": "Se trimite...",
    "invia": "Trimite cererea",
    "erroreInvio": "Eroare la trimitere. Încearcă din nou.",
    "erroreConnessione": "Eroare de conexiune. Încearcă din nou."
  },
  "diagnosi": {
    "elettrodomestici": {
      "Lavatrice": "Mașină de spălat",
      "Lavastoviglie": "Mașină de spălat vase",
      "Asciugatrice": "Uscător de rufe",
      "Frigorifero": "Frigider",
      "Forno": "Cuptor",
      "Piano cottura": "Plită",
      "Condizionatore": "Aer condiționat"
    },
    "pagato": {
      "titolo": "Plată confirmată!",
      "sottotitolo": "Perfect! În câteva secunde începe sesiunea ta de videodiagnoză.",
      "preparati": "Pregătește-te:",
      "spina": "Scoate din priză electrocasnicul",
      "luce": "Asigură-te că ai lumină bună",
      "telefono": "Ține telefonul pregătit pentru filmare",
      "attesa": "Sesiunea începe automat..."
    },
    "aggiorna": {
      "titolo": "Actualizează Fixi",
      "apri": "Deschide Play Store",
      "dopo": "Mai târziu"
    },
    "setup": {
      "titolo": "Diagnoză electrocasnic",
      "sottotitolo": "Economisește până la 70 € pe vizita tehnicianului. AI-ul nostru diagnostichează problema prin videochat.",
      "ripresaTitoloReferto": "Ai un raport nesalvat încă",
      ...
      "ripresaRicomincia": "Reîncepe",
      "domanda": "Ce electrocasnic?",
      "marca": "Marcă",
    ...
    "referto": {
      ...
      "utile": "Diagnoza a fost utilă?",
      "risoltoDaSolo": "Am rezolvat singur",
    ...
    "tecnico": {
      "inviata": "Cerere trimisă!",
      "avvisatoUno": "Am anunțat {quanti} tehnician din zona ta, cu raportul deja pregătit. Primul disponibil te va suna la numărul lăsat.",
      ...
      "citta": "Oraș",
      "cap": "Cod poștal *",
      "invioInCorso": "Se trimite...",
      "trova": "Găsește un tehnician în zona mea"
    },
    "rimborso": {
      "ricevuta": "Cerere primită. Îți răspundem prin email în câteva zile.",
      "racconta": "Spune-ne ce nu a funcționat. Dacă diagnosticul nu ți-a fost de folos, îți returnăm cei 9,90 €.",
      "email": "Emailul folosit pentru plată",
      "motivo": "De ce nu ți-a fost de folos?",
      "invio": "Se trimite...",
      "invia": "Trimite cererea",
      "annulla": "Anulează",
      "chiedi": "Diagnosticul nu ți-a fost de folos? Cere rambursarea"
    },
    "sessione": {
      "silenzia": "Dezactivează vocea",
      "attivaVoce": "Activează vocea",
      "spegniCamera": "Dezactivează camera",
      "accendiCamera": "Activează camera",
      "cameraSpenta": "Oprit",
      "analizza": "Analizează",
      "analizzaSpiega": "Analizează ce filmezi acum (sau apasă o tastă de volum)",
      ...
      "cameraSpentaRiquadro": "Camera nu este activă",
      "staAnalizzando": "AI analizează...",
      "inAttesa": "În așteptare...",
      "staAnalizzandoBolla": "📷 Analizez ce filmezi...",
      "preparoReferto": "📋 Pregătesc raportul…"
    },
    "errori": {
      "pagamentoNonValido": "Plată nevalidă.",
      "servizio": "Eroare de serviciu.",
      "generico": "⚠️ Ceva nu a mers bine. Încearcă din nou sau apasă 📋 Generează raportul pentru a salva diagnosticul de până acum.",
    ...
    "avvisi": {
      ...
      "salvataggioVecchiaApp": "Pentru a salva direct în Descărcări ai nevoie de ultima versiune Fixi: actualizeaz-o din Play Store. Între timp deschid partajarea: alege «Salvează în fișier».",
      "salvataggioAndroidVecchio": "Acest telefon are o versiune de Android care nu permite salvarea directă în Descărcări. Deschid partajarea: alege «Salvează în fișier».",
      "salvataggioAltro": "Salvarea în Descărcări a eșuat. Deschid partajarea: alege «Salvează în fișier».\n\nDacă poți, trimite acest detaliu celor care au creat aplicația: {dettaglio}",
      "condivisioneNonRiuscita": "Nu am reușit să partajez PDF-ul. Trimite-ți-l pe email mai jos: raportul este identic.",
      ...
      "refertoNonSalvato": "Încă nu ai salvat raportul și nici nu ți l-ai trimis pe email: dacă ieși acum, îl pierzi.\n\nVrei să ieși oricum?",
      "diagnosiInCorso": "Ești în mijlocul unui diagnostic pe care l-ai plătit.\n\nDacă ieși acum, îl poți relua de unde l-ai lăsat, timp de următoarele 2 ore.\n\nVrei să ieși?",
      "pagamentoNonConfermato": "Plata nu a fost confirmată. Încearcă din nou.",
      "pagamentoAnnullato": "Plata a fost anulată. Poți încerca din nou oricând.",
      "compilaTutto": "Completează toate câmpurile înainte de a continua.",
      "selezionaElettrodomestico": "Selectează electrocasnicul și descrie problema.",
      "emailNonValida": "Introdu o adresă de email validă.",
      "emailNonInviata": "Emailul nu a putut fi trimis. Încearcă din nou sau descarcă PDF-ul.",
      ...
      "tecnicoDati": "Introdu numele și telefonul: tehnicianul are nevoie de ele ca să te contacteze.",
      ...
      "vocalePermesso": "Pentru a dicta ai nevoie de permisiunea microfonului: o poți activa din setările telefonului.",
      "vocaleNonCapito": "Nu am înțeles ce ai spus. Încearcă din nou vorbind aproape de telefon sau scrie mesajul în căsuță.",
      "vocaleNonAvviata": "Nu am reușit să pornesc dictarea. Poți scrie mesajul în căsuță.\n\nDetaliu: {dettaglio}",
    ...
    "benvenuto": {
      "saluto": "Salut! Sunt Fixi. Văd că ai o problemă cu **{nome}**.",
      ...
      "targhetta": "Acum caută **plăcuța cu modelul** — este {dove} — încadreaz-o și apasă **📷 Analizează**, sau un **buton de volum** dacă telefonul e într-un loc incomod.",
      ...
      "sicurezza": {
        "Lavatrice": "**oprește-l și scoate-l din priză**, apoi închide robinetul de apă",
        "Lavastoviglie": "**oprește-l și scoate-l din priză**, apoi închide robinetul de apă",
        "Asciugatrice": "**oprește-o și scoate-o din priză**, și golește rezervorul de condens dacă e plin",
        "Frigorifero": "**scoate-l din priză** înainte să te uiți înăuntru — dacă va rămâne scos mult timp, salvează conținutul congelatorului",
        "Forno": "**oprește-l, scoate-l din priză și lasă-l să se răcească**. Dacă e pe gaz și simți miros de gaz, închide robinetul, nu aprinde nimic și deschide ferestrele",
        "Piano cottura": "dacă simți **miros de gaz**, închide imediat robinetul de gaz, **nu aprinde și nu stinge nimic** (nici măcar lumina) și deschide ferestrele. Dacă nu e miros de gaz, întrerupe curentul de la tablou",
        ...
        "predefinito": "**oprește-l și scoate-l din priză**"
      },
      "targhette": {
        "Lavatrice": "**în interiorul ușiței, pe margine**",
        "Lavastoviglie": "**în interiorul ușiței, pe margine**",
        "Asciugatrice": "**în interiorul ușiței**, sau pe spate",
        ...
        "predefinito": "de obicei **pe marginea ușiței** sau pe spate"
      }
    }
  }
};
