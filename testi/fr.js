...
//   node scripts/traduci.mjs fr

export default {
  "meta": {
    "titolo": "Fixi — Diagnostic électroménager par IA",
    "descrizione": "Économise sur la visite du technicien. Diagnostic IA par visioconférence en 10 minutes."
  },
  "nav": {
    "comeFunziona": "Comment ça marche",
    "guide": "Guides",
    "prezzi": "Tarifs",
    "tecnici": "Tu es technicien ?",
    "avvia": "Lancer le diagnostic"
  },
  "lingua": {
    "scegli": "Choisis ta langue",
    "disponibileIn": "Cette page est disponible en italien"
  },
  "hero": {
    "badge": "Diagnostic IA en 10 minutes",
    "titolo1": "Le lave-linge est en panne.",
    "titolo2": "Pas de panique.",
    "sottotitolo": "Une IA te guide par appel vidéo, identifie le problème et te remet un rapport précis. Sans attendre le technicien. Sans payer 80 € juste pour le faire venir.",
    "avvia": "Lancer le diagnostic",
    "comeFunziona": "Comment ça marche"
  },
  "telefono": {
    ...
    "bolla1": "J'ai vu le petit panneau. Essaie de dévisser le bouchon avec un chiffon — de l'eau résiduelle pourrait sortir.",
  ...
  "numeri": [
    ...
    {
      "valore": "70 €",
      "etichetta": "Économie moyenne"
    }
  ],
  "passi": {
    "tag": "Comment ça marche",
    "titolo1": "Quatre étapes.",
    "titolo2": "Problème résolu.",
    "sottotitolo": "Pas d'attente, pas de surprise. En moins de 15 minutes, tu sais exactement ce qui ne va pas.",
    "elenco": [
      {
        "titolo": "Décris le problème",
        "testo": "Sélectionne l'appareil, indique la marque et décris la panne en quelques mots."
      },
      {
        "titolo": "Paie 9,90 €",
      ...
      {
        "titolo": "Vidéo-appel avec l'IA",
        "testo": "Pointe la caméra vers l'appareil. L'IA analyse et te guide pas à pas."
      },
      {
        "titolo": "Reçois ton rapport",
        "testo": "Diagnostic, solution à faire soi-même et estimation des coûts si un technicien est nécessaire. En PDF."
      }
    ]
  },
  "perche": {
    "tag": "Pourquoi Fixi",
    "titolo1": "Diagnostic précis.",
    "titolo2": "Rapport en main.",
    "elenco": [
      {
        "titolo": "IA avec vision",
        "testo": "Le modèle voit ta machine en temps réel et analyse codes d'erreur, fuites, composants."
      },
      {
        "titolo": "Guide étape par étape",
        "testo": "Il ne te laisse pas seul. Il te dit exactement quoi faire, comment le faire et dans quel ordre."
      },
      {
        "titolo": "Rapport pour le technicien",
        "testo": "Si tu n'y arrives pas seul, tu as un document avec diagnostic et prix justes à montrer au technicien."
      },
      {
        "titolo": "Toutes les marques",
        "testo": "Bosch, Samsung, Indesit, Whirlpool, Miele, LG, Candy et bien d'autres."
      }
    ],
    "esempioTitolo": "Exemple de rapport",
    "referto": {
      "diagnosiEtichetta": "Diagnostic",
      "diagnosiValore": "Filtre de la pompe de vidange obstrué. Code E18 confirmé.",
      "soluzioneEtichetta": "Solution bricolage",
      "soluzioneValore": "Nettoyage du filtre en bas à droite. Guide inclus dans le PDF.",
      "tecnicoEtichetta": "Si besoin du technicien",
  ...
  "prezzi": {
    ...
    "sottotitolo": "Pas d'abonnement : tu payes seulement quand tu en as besoin.",
  ...
  "tecnici": {
    ...
    "sottotitolo": "Reçois des demandes qualifiées avec diagnostic déjà fait. Pas de frais d'inscription, pas de crédits à acheter : pendant cette phase de lancement, les contacts ne te coûtent rien.",
    "vantaggi": [
      {
        "titolo": "Des clients déjà qualifiés",
        "testo": "Ils arrivent avec diagnostic et rapport — tu sais déjà quoi faire avant de sortir."
      },
      {
        "titolo": "Coût zéro",
      ...
      },
      {
        ...
        "testo": "Avis vérifiés, badge qualité, plus de visibilité avec le temps."
      }
    ],
    "iscriviti": "Inscris-toi gratuitement",
    "scopri": "En savoir plus",
    "numeri": [
      {
        "valore": "0 €",
        "etichetta": "Coût d'inscription"
      },
      {
        "valore": "0%",
        "etichetta": "Commission sur les travaux"
      },
      {
        "valore": "48h",
  ...
  "emailTecnicoTrovato": {
    ...
    "sottotitolo": "Salut {nome}, un technicien a accepté ta demande et va bientôt te contacter. Voici ses coordonnées :",
    "campoNome": "Nom",
  ...
  "emailRecensione": {
    "oggetto": "Com'est passée la réparation ? Laisse un avis ({numero})",
    "intestazione": "Com'est passée la réparation ?",
    "saluto": "Bonjour {nome},",
  ...
  "pdf": {
    ...
    "piedeCentro": "Ce rapport est généré par un système d'IA à des fins de diagnostic."
  },
  "riparazione": {
    "titolo": "Ton devis",
    "lavoro": "Réparation {macchina}",
    "inAttesaTitolo": "Le technicien prépare ton devis",
    "inAttesaTesto": "On te prévient dès qu'il arrive. Ça prend généralement moins d'une journée.",
    "prezzoIntervento": "Prix de l'intervention",
    "creditoVideodiagnosi": "Crédit vidéodiagnostic Fixi",
    "daPagare": "À payer",
    "paga": "Payer {importo} et confirmer",
    "spiegazioneCredito": "Les {credito} payés pour le vidéodiagnostic sont déduits du paiement de la réparation.",
    "rifiuta": "Non merci",
    "confermaRifiuto": "Tu veux vraiment refuser ce devis ? Le rapport reste à toi et tu pourras demander un autre devis.",
    "pagatoTitolo": "Paiement reçu",
    "pagatoTesto": "Le technicien te contactera pour fixer l'intervention.",
    "inCorsoTitolo": "Intervention en cours",
    "completatoTitolo": "Réparation terminée",
    "completatoTesto": "Merci. Si tu veux, laisse un avis au technicien.",
    "annullatoTitolo": "Devis refusé",
    "annullatoTesto": "Le rapport du diagnostic reste à toi. Tu peux demander un autre technicien quand tu veux.",
    "riepilogo": "Récapitulatif",
    "pagatoPerDiagnosi": "Vidéodiagnostic",
    "pagatoPerRiparazione": "Solde réparation",
    "totale": "Total",
    "vocePagamento": "Réparation {macchina}",
    "vocePagamentoDettaglio": "Intervention {totale}, moins {credito} de crédit vidéodiagnostic déjà payé",
    "erroreGenerico": "Une erreur s'est produite. Réessaie dans un instant."
  },
  "privacy": {
    ...
    "chiSiamo": {
      ...
      "cosa": "Fixi est un service de diagnostic d'électroménagers par vidéoappel avec une intelligence artificielle, qui met également les utilisateurs en contact avec des techniciens réparateurs.",
    ...
    "dati": {
      ...
      "voci": [
        ...
        "**Images de la caméra** : pendant la session, les images filmées sont envoyées à l'IA pour analyse. **Nous ne conservons ni les vidéos ni les images** : elles sont traitées puis supprimées.",
        "**Email** : si tu choisis de recevoir le rapport par email ou d'être recontacté par un technicien.",
        "**Données pour la demande de technicien** : nom, téléphone, ville et code postal, que nous partageons avec les techniciens de ta région pour qu'ils puissent te contacter.",
    ...
    "perche": {
      "titolo": "3. Pourquoi nous les utilisons",
      "voci": [
        "Pour te fournir le diagnostic et générer le rapport.",
        "Pour t'envoyer le rapport par email, si tu le demandes.",
        "Pour te mettre en contact avec un technicien de ta région, si tu le demandes.",
    ...
    "camera": {
      "titolo": "4. La caméra",
      "testo": "L'accès à la caméra est utilisé **uniquement pendant la session de diagnostic** et seulement pour montrer à l'IA ce que tu filmes. Les images sont analysées en temps réel et ne sont pas stockées sur nos systèmes. Tu peux désactiver la caméra à tout moment pendant la session."
    },
    "terzeParti": {
      "titolo": "5. Services tiers",
      "intro": "Pour fonctionner, Fixi s'appuie sur des prestataires qui traitent certaines données pour notre compte :",
      "voci": [
    ...
    "conservazione": {
      ...
      "testo": "Nous conservons les données des sessions, des demandes d'intervention et des techniciens le temps nécessaire pour fournir le service et respecter les obligations légales. Tu peux nous demander à tout moment la suppression de tes données."
    },
    "diritti": {
      "titolo": "7. Tes droits",
    ...
    "minori": {
      "titolo": "8. Mineurs",
      "testo": "Fixi ne s'adresse pas aux mineurs de moins de 16 ans et nous ne collectons pas sciemment leurs données."
    },
    "modifiche": {
  ...
  "cancellazione": {
    ...
    "quale": {
      "titolo": "À quelle application cette page se réfère",
      "app": "Cette page concerne l'application **Fixi — Diagnostic Électroménager**, développée et publiée par **{titolare}**, ainsi que le site **Fixi**. Elle s'applique aussi bien aux personnes qui utilisent le service de diagnostic qu'aux techniciens inscrits au réseau.",
      "senzaAccount": "Fixi **n'a pas de compte ni d'inscription** : il n'existe pas de profil à supprimer depuis l'application. La suppression des données se demande en nous écrivant, comme expliqué ci-dessous."
    },
    "come": {
      "titolo": "Comment demander la suppression",
      "passo1": "Envoie un e-mail à {email} avec pour objet **« {oggetto} »**.",
      "passo2": "Dans le message, indique les données que tu nous as fournies, afin que nous puissions retrouver tes informations : l'**adresse e-mail** que tu as utilisée pour recevoir le rapport et, si tu as demandé l'intervention d'un technicien, également **ton nom, ton numéro de téléphone et ton code postal**.",
      "passo3": "Précise si tu veux supprimer **toutes les données** ou seulement une partie (par exemple uniquement la demande d'intervention).",
    ...
    "cosaSiCancella": {
      ...
      "voci": [
        "la **session de diagnostic** : appareil, marque, description du problème, la conversation avec l'assistant IA et le rapport généré ;",
        "ton **adresse e-mail**, si tu l'as laissée pour recevoir le rapport ;",
        ...
        "pour les techniciens inscrits : **l'intégralité de la fiche**, avec nom, prénom, e-mail, téléphone, ville, code postal, spécialisations et expérience."
      ],
    ...
    "cosaResta": {
      ...
      "voci": [
        ...
        "**Statistiques sous forme agrégée et anonyme** — par exemple « combien de diagnostics ont concerné un lave-linge ». Elles ne permettent pas de remonter jusqu'à toi et sont conservées sans limite de durée.",
        "**Données déjà partagées avec un technicien** — si tu as demandé une intervention et qu'un technicien a accepté la mission, il a déjà reçu tes coordonnées pour t'appeler. Nous supprimons la demande de nos systèmes, mais le technicien est responsable de manière autonome des données reçues : pour celles-ci, il faut le contacter directement. Sur demande, nous t'indiquons ses coordonnées."
      ],
    ...
    "altriDiritti": {
      ...
      "testo": "Outre la suppression, tu peux demander à accéder à tes données, à les corriger, à en limiter l'usage ou à t'opposer à leur traitement. Tu trouveras le cadre complet dans notre {link}.",
      "link": "politique de confidentialité",
      "scrivi": "Pour toute demande, écris à {email}."
    },
    "vaiAllaPrivacy": "Politique de confidentialité",
    "torna": "Retour à Fixi"
  },
  "stato": {
    "metaTitolo": "État technique — Fixi",
    "titolo": "État technique",
    "aCosaServe": "Ça permet de comprendre pourquoi quelque chose ne fonctionne pas. Prends une photo de cet écran et envoie-la à qui a créé l'app.",
    ...
    "versione": "Version installée",
    "nonDisponibile": "non disponible",
    "funzioni": "Fonctions natives",
    "troppoVecchia": "Cette version ne sait pas lister les plugins : elle est très ancienne.",
    "presente": "présent",
    "assente": "ABSENT",
    "prove": "Tests",
    "prova1": "1. Les messages s'affichent-ils ?",
    "prova2": "2. Écris un fichier dans Téléchargements",
    "prova3": "3. Vérifie le microphone",
    "prova4": "4. Génère le PDF du rapport",
    "prova5": "5. Rapport + sauvegarde, tout ensemble",
    "diario": "Journal de bord",
    "diarioSpiega": "Ce qui s'est passé en appuyant sur les vrais boutons. Si rien n'apparaît ici après avoir appuyé sur le micro ou Télécharger, ça veut dire que le toucher n'atteint même pas le code.",
  ...
  "tecnicoIscrizione": {
    ...
    "specializzazioni": {
      ...
      "Asciugatrici": "Sèche-linge",
      "Frigoriferi": "Réfrigérateurs",
      "Forni": "Fours",
      "Piani cottura": "Plaques de cuisson",
      "Climatizzatori": "Climatiseurs",
      "Caldaie": "Chaudières"
    },
    ...
    "passo1Sotto": "3 minutes suffisent. Aucun frais, aucun engagement.",
    "nome": "Prénom",
    "nomeEsempio": "Mario",
    "cognome": "Nom",
    ...
    "cap": "Code postal",
    "capEsempio": "20100",
    "specializzazioniTitolo": "Spécialisations",
    "anni": "Années d'expérience",
    "anniEsempio": "ex. 10",
    "passo3Titolo1": "Présente-toi",
    "passo3Titolo2": "à tes futurs clients.",
    "passo3Sotto": "Une courte description de qui tu es et comment tu travailles.",
    ...
    "seCambia": "Si à l'avenir nous introduisons une commission sur les interventions, on te préviendra par email à l'avance : tu pourras choisir de continuer ou de te désinscrire.",
    "indietro": "Retour",
    "continua": "Continuer",
    "invio": "Envoi...",
    "invia": "Envoyer la demande",
    "erroreInvio": "Erreur lors de l'envoi. Réessaie.",
    "erroreConnessione": "Erreur de connexion. Réessaie."
  },
  "diagnosi": {
    "elettrodomestici": {
      ...
      "Forno": "Four",
      "Piano cottura": "Plaque de cuisson",
      "Condizionatore": "Climatiseur"
    },
    "pagato": {
      ...
      "telefono": "Garde ton téléphone prêt à filmer",
      "attesa": "La session commence automatiquement..."
    },
    "aggiorna": {
      "titolo": "Mettre à jour Fixi",
      "apri": "Ouvrir le Play Store",
      "dopo": "Plus tard"
    },
    "setup": {
      "titolo": "Diagnostic électroménager",
      "sottotitolo": "Économise jusqu'à 70 € sur la visite du technicien. Notre IA diagnostique le problème par vidéo-appel.",
      ...
      "ripresaTestoMeta": "Tu peux la reprendre où tu en étais, sans repayer.",
      "ripresaApriReferto": "Rouvrir le rapport",
      "ripresaRiprendi": "Reprendre le diagnostic",
      "ripresaRicomincia": "Recommencer",
      "domanda": "Quel appareil ?",
      "marca": "Marque",
      "marcaEsempio": "ex. Bosch, Samsung, Indesit...",
      "problema": "Décris le problème",
      "problemaEsempio": "ex. Ne vidange pas l'eau, code erreur E18, bruit étrange...",
      "verifica": "Vérification du paiement...",
      "avvia": "Démarrer la vidéo-diagnostic",
      "paga": "Payer 9,90 € et démarrer le diagnostic",
    ...
    "referto": {
      "titolo": "Rapport de diagnostic",
      "diagnosi": "Diagnostic",
      "faiDaTe": "Solution à faire soi-même",
      "pezzo": "Pièce à remplacer",
      "codice": "Code :",
      "prezzoStimato": "Prix estimé :",
      "stimaIntervento": "Estimation d'intervention technicien",
      "mostraAlTecnico": "Montre ce rapport au technicien pour obtenir un prix juste.",
      "scarica": "Télécharger",
      "condividi": "Partager",
      ...
      "utile": "Le diagnostic t'a-t-il été utile ?",
      "risoltoDaSolo": "Résolu seul",
      "serveTecnico": "Besoin d'un technicien",
      "grazieFeedback": "Merci pour ton avis ! 🙏",
      "tornaHome": "Retour à l'accueil"
    },
    "tecnico": {
      "inviata": "Demande envoyée !",
      ...
      "nessuno": "Pour l'instant, il n'y a pas de techniciens actifs dans ta zone : nous avons enregistré ta demande et te contacterons dès que nous en trouvons un.",
      "creditoTitolo": "Tu as déjà {credito} de crédit sur la réparation",
      "creditoTesto": "Si tu répares via Fixi, les {credito} du diagnostic vidéo sont entièrement déduits du coût de l'intervention.",
      "trovaTecnico": "Trouve un technicien",
      ...
      "trova": "Trouver un technicien dans ma zone"
    },
    "rimborso": {
      ...
      "invia": "Envoyer la demande",
      "annulla": "Annuler",
      "chiedi": "Le diagnostic ne t'a pas aidé ? Demande un remboursement"
    },
    "sessione": {
      ...
      "analizza": "Analyser",
      "analizzaSpiega": "Analyse ce que tu filmes maintenant (ou appuie sur une touche de volume)",
    ...
    "avvisi": {
      "pdfNonRiuscito": "Je n'ai pas réussi à préparer le PDF. Fais-toi l'envoyer par e-mail ci-dessous : le rapport est identique.",
      ...
      "salvataggioAltro": "Échec de l'enregistrement dans les Téléchargements. J'ouvre le partage : choisis « Enregistrer dans un fichier ».\n\nSi tu peux, envoie ce détail à celui qui a créé l'appli : {dettaglio}",
      "condivisioneNonRiuscita": "Je n'ai pas réussi à partager le PDF. Fais-toi l'envoyer par e-mail ci-dessous : le rapport est identique.",
      ...
      "refertoNonSalvato": "Tu n'as pas encore enregistré le rapport ni te l'es fait envoyer par e-mail : si tu quittes maintenant, tu le perds.\n\nVeux-tu quitter quand même ?",
      "diagnosiInCorso": "Tu es en pleine session de diagnostic que tu as payée.\n\nSi tu quittes maintenant, tu la retrouveras là où tu l'as laissée, pendant les 2 prochaines heures.\n\nVeux-tu quitter ?",
      ...
      "emailNonInviata": "Impossible d'envoyer l'e-mail. Réessaie, ou télécharge le PDF.",
      ...
      "vocalePermesso": "Pour dicter, l'autorisation du microphone est nécessaire : tu peux l'activer dans les paramètres du téléphone.",
      ...
      "vocaleNonAvviata": "Je n'ai pas réussi à démarrer la dictée. Tu peux écrire le message dans le champ.\n\nDétail : {dettaglio}",
      "vocaleAltro": "Échec de la dictée ({motivo}). Tu peux écrire le message.",
      "vocaleBrowser": "Ton navigateur ne prend pas en charge la reconnaissance vocale. Utilise Chrome.",
      "vocaleNegatoBrowser": "L'autorisation du microphone a été refusée : tu peux l'accorder dans les paramètres du navigateur."
    },
    "benvenuto": {
      ...
      "primaDiToccarlo": "⚠️ **Avant d'y toucher :** {sicurezza}.",
      "targhetta": "Maintenant, cherche la **plaque signalétique** — elle se trouve {dove} — cadre-la et appuie sur **📷 Analyser**, ou sur une **touche de volume** si ton téléphone est mal placé.",
      ...
      "sicurezza": {
        ...
        "Asciugatrice": "**éteins-la et débranche-la**, et vide le bac à condensation s'il est plein",
        "Frigorifero": "**débranche-le** avant de regarder à l'intérieur — s'il doit rester débranché longtemps, sauve le contenu du congélateur",
      ...
      "targhette": {
        "Lavatrice": "**à l'intérieur de la porte, sur le bord**",
        ...
        "Forno": "**sur le bord de la porte**, en ouvrant la trappe",
        "Piano cottura": "**sous le plan de travail**, ou dans le mode d'emploi",
