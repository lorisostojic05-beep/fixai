...
export default {
    ...
    "elenco": [
      {
        ...
        "testo": "Le modèle voit ta machine en temps réel et analyse codes erreur, fuites, composants."
      },
      {
        "titolo": "Guide pas à pas",
  ...
  "tecnici": {
    ...
    "vantaggi": [
      {
        "titolo": "Clients déjà qualifiés",
        "testo": "Ils arrivent avec diagnostic et rapport — tu sais déjà quoi faire avant de te déplacer."
      },
      {
        "titolo": "Coût zéro",
  ...
  "tecnicoIscrizione": {
    ...
    "passo1Sotto": "Ça prend 3 minutes. Aucun coût, aucun engagement.",
    "nome": "Prénom",
    "nomeEsempio": "Mario",
    "cognome": "Nom",
    ...
    "passo3Sotto": "Une brève description de qui tu es et comment tu travailles.",
  ...
  "diagnosi": {
    ...
    "referto": {
      ...
      "stimaIntervento": "Estimation intervention technicien",
      "mostraAlTecnico": "Montre ce rapport au technicien pour obtenir un prix juste.",
      "scarica": "Télécharger",
      "condividi": "Partager",
      ...
      "utile": "Le diagnostic t'a été utile ?",
      "risoltoDaSolo": "Résolu tout seul",
      "serveTecnico": "Besoin d'un technicien",
      "grazieFeedback": "Merci pour ton retour ! 🙏",
      "tornaHome": "Retour à l'accueil"
    },
    "tecnico": {
      "inviata": "Demande envoyée !",
